...
#define SEND_FAIL 7
#define SEND_OTHER 8
#define SEND_REG_REMOTE_NOT_TRACED 20
...
#define RECV_REG_REMOTE_NOT_TRACED 18 // Use register to check border instead of reading header
#define RECV_REG_REMOTE_TRACED 19

#define WRITE_REG_REMOTE_NOT_TRACED 21
#define WRITEV_REG_REMOTE_NOT_TRACED 21
//#define RECV_ERROR 7
...
// define remotetrace buffer operation type
#define S_MARK 1
#define S_QUERY 2
...
// define central register parameters
#define REG_BUFFLEN 16
#define REG_SERVER_ADDR "101.6.30.196"
#define REG_SERVER_PORT 3212
// define local register parameters
...
typedef struct
{
    // flag 0: unused ; 1: remote peer is traced ;2: remote peer is not traced; other : a key for querying or deregistering
...
// listen
typedef int (*LISTEN)(int sockfd, int n);
...
typedef int (*FFLUSH)(FILE *stream);
...
// check whether a message uses HTTP
